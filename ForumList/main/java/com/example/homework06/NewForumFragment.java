...
import com.example.homework06.databinding.FragmentNewForumBinding;
...
public class NewForumFragment extends Fragment {
    ...
    private void setForumData() {
        ...
        if (forumTitle.isEmpty()) {
            ...
            newDoc.set(new Forum(DID, UID, forumTitle, forumDescription, creator, createdDateTime,likedUsers))
